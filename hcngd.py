...
img_back = "galaxy.jpg"
img_hero = "rocket (1).png"
img_hero1 = "rocket1.png"
img_hero2 = "rocket (1).png"
...
ship1 = Player1(img_hero1, 300, win_height - 100, 80, 100, 10)
...
while run:
    for e in event.get():
        if e.type == QUIT:
            ...
            if e.key == K_m:
                if num_fire1 < max_fire1 and rel_time1 == False:
            ...
            if e.key == K_g:
                if num_fire2 < max_fire2 and rel_time2 == False:
